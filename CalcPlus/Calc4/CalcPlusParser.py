...
class CalcPlusParser ( Parser ):
    ...
    ruleNames =  [ "calc4", "stmt", "expr", "cond", "block" ]
    ...
    class Calc4Context(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterCalc4" ):
                listener.enterCalc4(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitCalc4" ):
                listener.exitCalc4(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitCalc4" ):
                return visitor.visitCalc4(self)
            else:
    ...
    def calc4(self):
        ...
        localctx = CalcPlusParser.Calc4Context(self, self._ctx, self.state)
        self.enterRule(localctx, 0, self.RULE_calc4)
