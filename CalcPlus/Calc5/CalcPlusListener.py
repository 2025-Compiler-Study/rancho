...
class CalcPlusListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CalcPlusParser#program.
    def enterProgram(self, ctx:CalcPlusParser.ProgramContext):
        pass

    # Exit a parse tree produced by CalcPlusParser#program.
    def exitProgram(self, ctx:CalcPlusParser.ProgramContext):
        pass


    # Enter a parse tree produced by CalcPlusParser#Declare.
    def enterDeclare(self, ctx:CalcPlusParser.DeclareContext):
        pass

    # Exit a parse tree produced by CalcPlusParser#Declare.
    def exitDeclare(self, ctx:CalcPlusParser.DeclareContext):
        pass
    ...
    # Enter a parse tree produced by CalcPlusParser#StmtBlock.
    def enterStmtBlock(self, ctx:CalcPlusParser.StmtBlockContext):
        pass

    # Exit a parse tree produced by CalcPlusParser#StmtBlock.
    def exitStmtBlock(self, ctx:CalcPlusParser.StmtBlockContext):
        pass
